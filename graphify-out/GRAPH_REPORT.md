...
## Corpus Check
- 107 files · ~1,103,530 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 930 nodes · 1610 edges · 108 communities (42 shown, 66 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 5 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f3bc28b8`
...
Cohesion: 0.07
Nodes (78): AppNav(), items, HeroSection(), rankForStreak(), today(), CinematicLoader(), CursorRipple, CustomCursor() (+70 more)
...
### Community 65 - "Task: Implement a Scroll‑Scrubbed Video Hero Section for Shadow Level"
Cohesion: 0.40
Nodes (4): 1. Frame Extraction (FFmpeg), Context, Step‑by‑Step Instructions, Task: Implement a Scroll‑Scrubbed Video Hero Section for Shadow Level

## Knowledge Gaps
- **351 isolated node(s):** `$schema`, `style`, `rsc`, `tsx`, `css` (+346 more)
...
- **Why does `cn()` connect `cn` to `alert.tsx`, `sidebar.tsx`, `dashboard.tsx`, `table.tsx`, `toggle-group.tsx`, `dropdown-menu.tsx`, `button.tsx`, `utils.ts`, `badge.tsx`, `command.tsx`, `menubar.tsx`, `card.tsx`, `form.tsx`, `chart.tsx`, `navigation-menu.tsx`, `queries.ts`, `carousel.tsx`?**
